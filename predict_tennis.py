...
def predict_match(
    ...
    extreme_edge = config["betting"].get("extreme_edge", 0.20)
    extreme_flag = abs(alert_edge) > extreme_edge
...
def print_alert_preview(p: Prediction, paper_mode: bool) -> None:
    ...
    extreme = "  [!EXTREME -- gap > threshold, verify before betting]" if p.extreme_flag else ""
